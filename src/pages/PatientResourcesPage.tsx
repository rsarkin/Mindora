...
import { X, Play, BookOpen, Video, FileText, Sparkles, Filter, ChevronRight } from "lucide-react";
...
export const PatientResourcesPage: React.FC = () => {
    ...
    const resources: Resource[] = [
        {
            ...
            description: "A gentle introduction to mindfulness meditation. Perfect if you are just starting out and need a calm space.",
            duration: "10:24"
        },
        {
            id: "v2",
            ...
            description: "Fall asleep faster and achieve a deeper, more restful state with this calming guided sleep meditation.",
            duration: "45:12"
        },
        {
            id: "v3",
            ...
            description: "Quick and highly effective breathing techniques designed to calm anxiety and reduce a racing heart.",
            duration: "8:15"
        },
        {
            id: "v4",
            ...
            description: "A gentle yoga practice to clear your mind, relieve brain fog, and bring clarity to your day.",
            duration: "15:30"
        },
        {
            id: "a1",
            ...
            description: "Comprehensive scientific guide to recognizing, decoding, and managing sudden panic attacks.",
            duration: "5 min read"
        },
        {
            id: "a2",
            ...
            description: "Science-backed strategies and actionable tips for completely overhauling your sleep quality and habits.",
            duration: "7 min read"
        },
        {
            id: "a3",
            ...
            description: "Explore the thoroughly evidence-based benefits of maintaining a regular mindfulness meditation practice.",
            duration: "6 min read"
        },
        {
            id: "a4",
            ...
            description: "Practical tools and proven psychological techniques for managing depressive episodes and regaining control.",
            duration: "12 min read"
        }
    ];

    // Refresh logic: Rotate content every 3 days based on current date
    const seed = Math.floor(new Date().getTime() / (1000 * 60 * 60 * 24 * 3));

    // Pseudo-random shuffler based on the seed
    const seededRandom = (s: number) => {
        const x = Math.sin(s++) * 10000;
        return x - Math.floor(x);
    };

    const shuffleArray = <T,>(array: T[], seedOffset: number): T[] => {
    ...
    // Shuffle videos and articles to present "fresh" content every 3 days
    const videos = shuffleArray(filteredResources.filter(r => r.type === "video"), 1);
    const articles = shuffleArray(filteredResources.filter(r => r.type === "article"), 2);
    ...
    return (
        ...
        >
            ...
            <motion.div variants={STAGGER_CHILD_VARIANTS} className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                ...
                {/* AI Helper Callout */}
                <div onClick={() => navigate('/messages')} className="flex items-center gap-4 bg-gradient-to-r from-primary-50 to-indigo-50 border border-primary-100/50 p-4 rounded-2xl cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all group">
